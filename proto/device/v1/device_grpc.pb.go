...
const (
	...
	DeviceService_ListDevice_FullMethodName   = "/device.v1.DeviceService/ListDevice"
)
...
type DeviceServiceClient interface {
	...
	ListDevice(ctx context.Context, in *ListDeviceRequest, opts ...grpc.CallOption) (*DeviceListResponse, error)
}
...
func (c *deviceServiceClient) ListDevice(ctx context.Context, in *ListDeviceRequest, opts ...grpc.CallOption) (*DeviceListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeviceListResponse)
	err := c.cc.Invoke(ctx, DeviceService_ListDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeviceServiceServer interface {
	...
	ListDevice(context.Context, *ListDeviceRequest) (*DeviceListResponse, error)
...
func (UnimplementedDeviceServiceServer) ListDevice(context.Context, *ListDeviceRequest) (*DeviceListResponse, error) {
...
func _DeviceService_ListDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListDeviceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeviceServiceServer).ListDevice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeviceService_ListDevice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).ListDevice(ctx, req.(*ListDeviceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeviceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _DeviceService_ListDevice_Handler,
		},
	},
