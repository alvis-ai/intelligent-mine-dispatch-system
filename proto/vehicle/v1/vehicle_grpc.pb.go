...
const (
	...
	VehicleService_UpdateVehicle_FullMethodName = "/vehicle.v1.VehicleService/UpdateVehicle"
	VehicleService_DeleteVehicle_FullMethodName = "/vehicle.v1.VehicleService/DeleteVehicle"
	VehicleService_ListVehicle_FullMethodName   = "/vehicle.v1.VehicleService/ListVehicle"
)
...
type VehicleServiceClient interface {
	...
	DeleteVehicle(ctx context.Context, in *DeleteVehicleRequest, opts ...grpc.CallOption) (*VehicleResponse, error)
	ListVehicle(ctx context.Context, in *ListVehicleRequest, opts ...grpc.CallOption) (*VehicleListResponse, error)
}
...
func (c *vehicleServiceClient) GetVehicle(ctx context.Context, in *GetVehicleRequest, opts ...grpc.CallOption) (*VehicleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VehicleResponse)
...
func (c *vehicleServiceClient) DeleteVehicle(ctx context.Context, in *DeleteVehicleRequest, opts ...grpc.CallOption) (*VehicleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VehicleResponse)
...
func (c *vehicleServiceClient) ListVehicle(ctx context.Context, in *ListVehicleRequest, opts ...grpc.CallOption) (*VehicleListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VehicleListResponse)
	err := c.cc.Invoke(ctx, VehicleService_ListVehicle_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VehicleServiceServer interface {
	...
	DeleteVehicle(context.Context, *DeleteVehicleRequest) (*VehicleResponse, error)
	ListVehicle(context.Context, *ListVehicleRequest) (*VehicleListResponse, error)
...
func (UnimplementedVehicleServiceServer) GetVehicle(context.Context, *GetVehicleRequest) (*VehicleResponse, error) {
...
func (UnimplementedVehicleServiceServer) DeleteVehicle(context.Context, *DeleteVehicleRequest) (*VehicleResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVehicle not implemented")
}
func (UnimplementedVehicleServiceServer) ListVehicle(context.Context, *ListVehicleRequest) (*VehicleListResponse, error) {
...
var VehicleService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/vehicle/v1/vehicle.proto",
}
